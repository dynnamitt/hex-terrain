...
use super::entities::{CameraAltitude, CameraCell, CursorRecentered, TerrainCamera};
...
pub fn move_camera(
    ...
    mut altitude: ResMut<CameraAltitude>,
    ...
    if keys.pressed(KeyCode::KeyE) {
        altitude.0 += cfg.move_speed * time.delta_secs();
    }
